export const USERS_MESSAGES = {
  ...
  PASSWORD_RESET_REQUIRED: 'Password reset is required. Please check your email to set a new password.',
...
export const ADMIN_MESSAGES = {
  ...
  RESET_USER_PASSWORD_SUCCESS: 'Password reset email sent successfully',
